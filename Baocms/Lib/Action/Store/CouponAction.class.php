...
class CouponAction extends CommonAction {
    ...
    private $create_fields = array( 'title', 'photo', 'expire_date','num','limit_num', 'intro','condition','money');
    private $edit_fields = array( 'title', 'photo', 'expire_date','num','limit_num', 'intro','condition','money');
