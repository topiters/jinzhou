...
class ScratchAction extends CommonAction {
    private $create_fields = array('scratch_id','shop_id','keyword','title','intro','photo','stime','ltime','use_tips','end_tips','predict_num','max_num','follower_condtion','member_condtion','collect_count','views','end_photo','clientip','dateline','unluck');
    private $edit_fields = array('scratch_id','shop_id','keyword','title','intro','photo','stime','ltime','use_tips','end_tips','predict_num','max_num','follower_condtion','member_condtion','collect_count','views','end_photo','clientip','dateline','unluck');
    private $goodscreate_fields = array('id','scratch_id','title','name','num','luck','photo','shop_id');
	private $goodsedit_fields = array('id','scratch_id','title','name','num','luck','photo','shop_id');
